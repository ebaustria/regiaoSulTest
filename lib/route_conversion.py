...
def make_routes():
    ...
    with open("CerritoPassoDasPedrasFaixaPelotas_gps_nodes.wkt", 'r') as cerrito_pelotas:
        ...
        nodes_list = wkt_parser.parse_wkt(nodes)
        #color = make_color()
        color = [255, 0, 0]

    route_list = wkt_parser.build_list("Cerrito Passo Das Pedras Faixa Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Piratini Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Piratini Pinheiro Machadovia Joao Saraiva", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Pelotas Pedro Osorio Piratini", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Pedro Osorio Bage", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Pedro Osorio Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Jaguarao Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Jaguarao Arroio Grande", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Herval Arroio Grande", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Cangucu Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Arroio Grande Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Cerrito Pedro Osorio", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Piratini Cerrito", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Pinheiro Machado Pedras Altas Herval Jaguarao", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Pinheiro Machado Pedras Altas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Pedras Altas Herval", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Jaguarao Pedro Osorio", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Herval Pedro Osorio", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Cangucu Piratini", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Bage Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Arroio Grande Pedro Osorio", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Bage Pedro Osorio Arroio Grande Jaguarao", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Bage Piratini", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Bage Pinheiro Machado Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Herval Pedro Osorio Pelotas", color, nodes_list, route_list)
    ...
    route_list = wkt_parser.build_list("Herval Arroio Grande Pelotas", color, nodes_list, route_list)
